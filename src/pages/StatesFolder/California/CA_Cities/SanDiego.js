    ...
    return (
        <div className='city-dropdown'>
            ...
            <div className='city-dropdown-content'>
                ...
                <a href='https://www.sandiego.gov/sites/default/files/legacy/publicworks/pdf/edocref/ros14492.pdf' target={'_blank'} rel='noreferrer'>Benchmarks PDF Data Sheets</a>
            </div>
        </div>
    )
}
