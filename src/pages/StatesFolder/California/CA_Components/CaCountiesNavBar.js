...
export default function CaCountiesNavBar() {
    ...
    let customLinkList = [
                ...
                <CustomLink key={'calaveras'} to="/calaveras">Calaveras <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                <CustomLink key={'el dorado'} to="/eldorado">El Dorado <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                ...
                <CustomLink key={'lassen'} to="/lassen">Lassen <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                <CustomLink key={'los angeles'} to="/losangeles">Los Angeles</CustomLink>,
                <CustomLink key={'marin'} to="/marin">Marin</CustomLink>,
                <CustomLink key={'modoc'} to="/modoc">Modoc <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                <CustomLink key={'merced'} to="/merced">Merced</CustomLink>,
                <CustomLink key={'monterey'} to="/monterey">Monterey</CustomLink>,
                <CustomLink key={'mono'} to="/mono">Mono <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                <CustomLink key={'nevada'} to="/nevada">Nevada <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                <CustomLink key={'orange'} to="/orange">Orange</CustomLink>,
                <CustomLink key={'placer'} to="/placer">Placer</CustomLink>,
                <CustomLink key={'plumas'} to="/plumas">Plumas <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                ...
                <CustomLink key={'siskiyou'} to="/siskiyou">Siskiyou <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                <CustomLink key={'sierra'} to="/sierra">Sierra <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                <CustomLink key={'sutter'} to="/sutter">Sutter <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                <CustomLink key={'tulare'} to="/tulare">Tulare</CustomLink>,
                <CustomLink key={'tehama'} to="/tehama">Tehama <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                <CustomLink key={'trinity'} to="/trinity">Trinity <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>,
                <CustomLink key={'ventura'} to="/ventura">Ventura</CustomLink>,
                <CustomLink key={'yolo'} to="/yolo">Yolo</CustomLink>,
                <CustomLink key={'yuba'} to="/yuba">Yuba <strong>&nbsp;&nbsp;**NEW**</strong></CustomLink>
            ]
